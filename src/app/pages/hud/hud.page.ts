...
export class HudPage implements OnInit, AfterViewInit, OnDestroy {
  ...
  async saveVisualSelection(category: string, templateId: string) {
    ...
    try {
      ...
      const visualData: ServicesHudRecord = {
      ...
      message: `
        <div style="text-align: left; font-family: monospace; font-size: 12px;">
          ...
          ${this.visualRecordIds[key] ? 
            ...
            (answersText ? 'ÃƒÂ¢Ã…Â¾Ã¢â‚¬Â¢ CREATE new Services_HUD record' : 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â No action - no selections')}<br>
        </div>
      `,
      buttons: ['Continue'],
      cssClass: 'wide-alert'
      ...
      if (item.selectedOptions && item.selectedOptions.length > 0) {
        if (existingVisualId) {
          ...
          const createAlert = await this.alertController.create({
            ...
            message: `
              <div style="font-family: monospace; font-size: 12px;">
                <strong style="color: blue;">ÃƒÂ¢Ã…Â¾Ã¢â‚¬Â¢ CREATING Services_HUD</strong><br><br>
