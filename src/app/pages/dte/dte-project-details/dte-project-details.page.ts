...
import { DteStateService, DteProjectData } from '../services/dte-state.service';
import { CaspioService } from '../../../services/caspio.service';
import { OfflineService } from '../../../services/offline.service';

@Component({
  selector: 'app-dte-project-details',
  templateUrl: './dte-project-details.page.html',
  styleUrls: ['./dte-project-details.page.scss'],
  standalone: true,
  imports: [CommonModule, IonicModule, FormsModule]
})
export class DteProjectDetailsPage implements OnInit {
  projectId: string = '';
  serviceId: string = '';
