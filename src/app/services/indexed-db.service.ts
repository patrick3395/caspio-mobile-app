...
export class IndexedDbService {
   ...
   */
  async getAllCachedServiceData(dataType: 'visuals' | 'hud' | 'lbw_records' | 'visual_attachments' | 'efe_point_attachments' | 'efe_rooms' | 'efe_points'): Promise<{ serviceId: string; data: any[] }[]> {
    const allCached = await db.cachedServiceData.toArray();
