...
export interface PendingCaptionUpdate {
  ...
  attachType: 'visual' | 'efe_point' | 'fdf' | 'hud' | 'lbw' | 'dte' | 'csa';  // Type of attachment
...
export class IndexedDbService {
   ...
   */
  async getAllCachedServiceData(dataType: 'visuals' | 'hud' | 'lbw_records' | 'dte' | 'visual_attachments' | 'efe_point_attachments' | 'efe_rooms' | 'efe_points'): Promise<{ serviceId: string; data: any[] }[]> {
    const allCached = await db.cachedServiceData.toArray();
