...
export class PaypalPaymentModalComponent implements OnInit, AfterViewInit {
  ...
  async showZelleInfo() {
    const alert = await this.alertController.create({
      ...
      message: '<div class="zelle-pay-to">Pay to</div><div class="zelle-details">We prefer Zelle payments to avoid transaction fees (we choose not to pass these fees on to our partners).</div><div class="zelle-recipient"><div class="zelle-name">Name: Patrick Bullock</div><div class="zelle-number">Number: (512) 298-9395</div></div>',
      buttons: [
        {
          text: 'OK',
