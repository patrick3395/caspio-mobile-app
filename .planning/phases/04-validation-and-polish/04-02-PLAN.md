...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    **TC-04: IndexedDB Connection Error Recovery**
    1. Open HUD category detail page and note field count
    ...
    4. Watch console for "[LIVEQUERY]" messages
    5. VERIFY: UI never shows empty/cleared data - always shows last known good state
    6. VERIFY: If connection error occurs, see "[LIVEQUERY] Returning cached data" in console
