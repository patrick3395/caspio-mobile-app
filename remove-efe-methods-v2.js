 ...
 * Enhanced version with explicit method name list
 */
...
// Explicit list of methods to remove (FDF and Room/Point photo methods)
const EXPLICIT_REMOVE_METHODS = [
  'takeFDFPhoto',
  'processFDFPhoto',
  'viewFDFPhoto',
  'annotateFDFPhoto',
  ...
  'takeFDFPhotoCamera',
  'takeFDFPhotoGallery',
  'processRoomPointPhoto',
  'uploadPhotoToRoomPoint',
  'uploadPhotoToRoomPointFromFile',
  'performRoomPointPhotoUpload',
  'takePhotoForElevationPoint',
  'viewRoomPhoto',
  'saveRoomPhotoCaption',
  'deleteRoomPhoto',
  'capturePointPhoto',
  'capturePointPhotoCamera',
  'capturePointPhotoGallery',
  'getPointPhotoByType',
  'viewElevationPhoto',
  'annotateElevationPhoto',
  'deleteElevationPhoto',
  'retryQueuedPhotosForPoint',
  'shouldShowThresholdFDF',
  'shouldShowFDFPhotos',
  'addBaseStation',
  'showRoomLocationFDFPopup',
];
...
/**
 * Check if a method name should be removed
 */
function shouldRemoveMethod(methodName) {
  ...
  if (EXPLICIT_REMOVE_METHODS.includes(methodName)) {
    return true;
  }
 ...
 */
function main() {
  console.log('Reading file from backup...');
  const sourceCode = fs.readFileSync(FILE_PATH + '.backup', 'utf-8');
  ...
  console.log(`Original backup at: ${FILE_PATH}.backup`);
}
